...
export const fiveWhysWorkflow = {
	...
	description:
		"Drill down through layers of causation to uncover root causes - essential for solving problems at their source",
	tags: {
		type: "technique",
		category: "deep",
						...
						valueSchema: {
							...
							properties: {
								...
								answer: {
									type: "string",
									description:
										"The final clarified answer from the conversation",
								},
							},
						},
