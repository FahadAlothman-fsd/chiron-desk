...
export const scamperWorkflow = {
	...
	description:
		"Systematic creativity through seven lenses: Substitute, Combine, Adapt, Modify, Put to other uses, Eliminate, Reverse",
	tags: {
		type: "technique",
		category: "structured",
				...
				tools: [
					{
						...
						usageGuidance:
							"After user explores substitution (they've given 2-3 ideas), use this to save their ideas. Then celebrate and move to COMBINE lens with enthusiasm!",
					...
					},
					{
						...
						usageGuidance:
							"After substitute complete, ask with energy: '✨ Amazing! Now let's COMBINE - what could you merge or integrate together?' Then save ideas.",
					...
					},
					{
						...
						usageGuidance:
							"After combine complete, ask: '🔧 Fantastic! How could you ADAPT or adjust this to fit different contexts?' Then save ideas.",
					...
					},
					{
						...
						usageGuidance:
							"After adapt complete, ask: '🎨 Love it! What could you MODIFY - make bigger, smaller, faster, slower, or change in some way?' Then save ideas.",
					...
					},
					{
						...
						usageGuidance:
							"After modify complete, ask: '💡 Brilliant! What OTHER USES could this have? Different contexts, audiences, or applications?' Then save ideas.",
					...
					},
					{
						...
						usageGuidance:
							"After put-to-use complete, ask: '✂️ Excellent! What could you ELIMINATE or simplify? What's unnecessary?' Then save ideas.",
					...
					},
					{
						...
						usageGuidance:
							"After eliminate complete, ask the FINAL question: '🔄 Last one! What could you REVERSE or flip upside down? Do the opposite?' Then save ideas and CELEBRATE COMPLETION: 'WOW! We just SCAMPERED through 7 lenses! Look at all these creative ideas! 🎉'",
