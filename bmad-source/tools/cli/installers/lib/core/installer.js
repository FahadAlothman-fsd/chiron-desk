...
class Installer {
	...
	async install(config) {
		...
		const bmadFolderName =
			moduleConfigs.core && moduleConfigs.core.bmad_folder
		...
		try {
			...
			const modulesToInstall = config.installCore
				? ["core", ...config.modules]
				: config.modules;
			...
			const allModulesToList = config._preserveModules
