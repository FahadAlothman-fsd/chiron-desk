...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      "bg-background text-foreground flex h-full w-full flex-col overflow-hidden rounded-none",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    className="flex items-center border-b border-border/80 px-3"
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none flex-col gap-1 rounded-none px-2 py-2 text-sm outline-none data-[disabled=true]:pointer-events-none data-[selected=true]:bg-muted data-[selected=true]:text-foreground data-[disabled=true]:opacity-55",
      className,
    )}
    {...props}
  />
