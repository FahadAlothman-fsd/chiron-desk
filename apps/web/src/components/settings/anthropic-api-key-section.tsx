...
export function AnthropicApiKeySection() {
	...
	const { data: keyData, isLoading } =
		trpc.settings.getAnthropicApiKey.useQuery();

	// Mutations
	const saveKeyMutation = useMutation({
		mutationFn: (key: string) =>
			trpcClient.settings.saveAnthropicApiKey.mutate({ key }),
		onSuccess: () => {
	...
	const testKeyMutation = useMutation({
		mutationFn: (key: string) =>
			trpcClient.settings.testAnthropicApiKey.mutate({ key }),
		onSuccess: (data) => {
