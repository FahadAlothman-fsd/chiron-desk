              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {/* Path Description */}
                    <p className="mb-3 text-muted-foreground text-sm">{path.description}</p>
                    ...
                    {path.deliverables && path.deliverables.length > 0 && (
                      <div className="mt-3 rounded-md bg-muted/50 p-3">
                        <div className="mb-2 font-medium text-sm">What you'll get:</div>
                        <ul className="space-y-1 text-sm">
                    ...
                    <div className="mt-3 flex gap-2">
                      {complexityTag && (
                        <Badge variant="secondary">{complexityTag.replace(/-/g, " ")}</Badge>
                      )}
                      {fieldTypeTag && <Badge variant="secondary">{fieldTypeTag}</Badge>}
                    </div>
                  </div>
                </div>
              </div>
