...
export function SimpleFormStep({ step, onComplete, onBack }: SimpleFormStepProps) {
    ...
    >
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          />
          <p className="text-muted-foreground text-sm">Give your project a descriptive name</p>
        </div>
      </div>
    </WizardStepContainer>
  );
