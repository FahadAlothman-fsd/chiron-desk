...
export function CardHeader({ option, displayConfig, isSelected, isRecommended }: CardHeaderProps) {
  // Extract values using displayConfig paths
  const title = getValueByPath<string>(option, displayConfig.fields.title, "Untitled");
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex items-start justify-between gap-2">
        ...
        {isSelected && <span className="shrink-0 font-medium text-primary text-sm">✓</span>}
      </div>
