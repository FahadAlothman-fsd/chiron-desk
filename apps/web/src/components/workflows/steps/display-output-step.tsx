...
export function DisplayOutputStep({ config, variables, onContinue }: DisplayOutputStepProps) {
    ...
    <div className="mx-auto flex w-full max-w-2xl flex-col space-y-6">
      <Card>
        <CardContent className="pt-6">
          <Streamdown className="prose dark:prose-invert max-w-none">{content}</Streamdown>
        </CardContent>
      </Card>
