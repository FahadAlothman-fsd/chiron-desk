  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="border-border border-b bg-background p-4">
        ...
        <p className="text-muted-foreground text-xs">Browse all steps and their progress</p>
      </div>
                ...
                <div className="space-y-2 p-4">
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-muted-foreground text-xs leading-relaxed">{step.goal}</p>
                    </div>
                  </div>
                  ...
                  {execution.startedAt && (
                    <div className="flex items-center gap-4 pt-1 text-muted-foreground text-xs">
                      ...
                      {execution.completedAt && (
                        <span>Completed: {formatTimestamp(execution.completedAt)}</span>
                      )}
      ...
      <div className="border-border border-t p-4">
        <Button onClick={onReturnToFocused} className="w-full" variant="default">
          ⬆️ Focus Active Step
        </Button>
      </div>
    </div>
