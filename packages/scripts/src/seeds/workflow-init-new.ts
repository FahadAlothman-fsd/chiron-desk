  ...
  const step1Config: AskUserChatStepConfig = {
    ...
    tools: [
        ...
        axSignature: {
          input: [
            ...
            },
            {
              ...
              description: "Available complexity levels with structured metadata",
            },
          ],
          output: [
            {
      ...
      // Tool 3: Select Workflow Path
      {
        ...
        optionsSource: {
          table: "workflow_paths",
          selectFields: ["id", "name", "displayName", "description", "tags", "phases"], // Fetch full records
          filterBy: {
        ...
        axSignature: {
          input: [
            ...
            },
            {
              ...
              description: "Available workflow paths filtered by complexity and field type",
            },
            {
              name: "project_description",
              type: "string",
