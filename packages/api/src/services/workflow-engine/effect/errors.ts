...
export class ExecutionNotFoundError extends Data.TaggedError("ExecutionNotFoundError")<{
...
export type WorkflowError = WorkflowNotFoundError | ExecutionNotFoundError | MaxStepsExceededError;
...
export class UnknownStepTypeError extends Data.TaggedError("UnknownStepTypeError")<{
  readonly stepType: string;
}> {}

export type StepError = StepTimeoutError | StepValidationError | UnknownStepTypeError;
...
export class ApprovalRejectedError extends Data.TaggedError("ApprovalRejectedError")<{
  readonly stepId: string;
  readonly reason?: string;
}> {}

export type AgentError = AgentStreamError | ToolExecutionError | ApprovalRejectedError;

export type AllWorkflowErrors = WorkflowError | StepError | VariableError | AgentError;
