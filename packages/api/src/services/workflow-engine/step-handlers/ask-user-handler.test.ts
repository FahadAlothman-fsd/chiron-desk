...
describe("AskUserStepHandler", () => {
  ...
  describe("path validation", () => {
    ...
    it("should reject relative path", async () => {
      ...
      await expect(handler.executeStep(mockStep, mockContext, "./my-project")).rejects.toThrow(
        ValidationError,
      );
    ...
    it("should reject directory traversal", async () => {
      ...
      await expect(handler.executeStep(mockStep, mockContext, testPath)).rejects.toThrow(
  ...
  describe("string validation", () => {
    it("should accept valid string", async () => {
      ...
      const result = await handler.executeStep(mockStep, mockContext, "My Project");
    ...
    it("should reject string shorter than minLength", async () => {
      ...
      await expect(handler.executeStep(mockStep, mockContext, "Hi")).rejects.toThrow(
    ...
    it("should reject string longer than maxLength", async () => {
      ...
      await expect(
        handler.executeStep(mockStep, mockContext, "This is a very long project name"),
    ...
    it("should validate pattern", async () => {
      ...
      // Should pass
      const result = await handler.executeStep(mockStep, mockContext, "my-project-123");
      expect(result.output).toEqual({
  ...
  describe("boolean validation", () => {
    ...
    it("should reject invalid boolean values", async () => {
      ...
      await expect(handler.executeStep(mockStep, mockContext, "invalid")).rejects.toThrow(
  ...
  describe("number validation", () => {
    ...
    it("should enforce min value", async () => {
      ...
      await expect(handler.executeStep(mockStep, mockContext, 5)).rejects.toThrow("at least 10");
    });
    ...
    it("should enforce max value", async () => {
      ...
      await expect(handler.executeStep(mockStep, mockContext, 150)).rejects.toThrow("at most 100");
    });
    ...
    it("should reject invalid numbers", async () => {
      ...
      await expect(handler.executeStep(mockStep, mockContext, "not-a-number")).rejects.toThrow(
