...
export const RuntimeInvokeWorkUnitBindingPreview = Schema.Struct({
  ...
  editorNestedFields: Schema.optional(Schema.Array(RuntimeFormNestedField)),
  ...
  sourceContextFactLabel: Schema.optional(Schema.String),
...
export const RuntimeInvokeStepExecutionDetailBody = Schema.Struct({
  ...
  sourceContextFactCardinality: Schema.optional(FactCardinality),
  sourceContextFactValueType: Schema.optional(Schema.String),
  sourceContextFactWorkUnitDefinitionName: Schema.optional(Schema.String),
