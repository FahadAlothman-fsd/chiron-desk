...
export type WorkflowEvent =
  | { readonly _tag: "WorkflowStarted"; readonly executionId: string; readonly workflowId: string }
  | {
  ...
  | { readonly _tag: "WorkflowError"; readonly executionId: string; readonly error: string }
  | {
