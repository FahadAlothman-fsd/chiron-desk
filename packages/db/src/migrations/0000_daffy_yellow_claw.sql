...
CREATE TABLE `methodology_agent_types` (
	...
	`prompt_template_version` integer DEFAULT 1 NOT NULL,
	`guidance_json` text,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `methodology_asd_vid_wut_key_idx` ON `methodology_artifact_slot_definitions` (`methodology_version_id`,`work_unit_type_id`,`key`);--> statement-breakpoint
CREATE INDEX `methodology_asd_vid_wut_idx` ON `methodology_artifact_slot_definitions` (`methodology_version_id`,`work_unit_type_id`);--> statement-breakpoint
CREATE TABLE `methodology_artifact_slot_templates` (
	...
	`updated_at` integer DEFAULT (cast(unixepoch('subsec') * 1000 as integer)) NOT NULL,
	FOREIGN KEY (`methodology_version_id`) REFERENCES `methodology_versions`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`slot_definition_id`) REFERENCES `methodology_artifact_slot_definitions`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
CREATE UNIQUE INDEX `methodology_ast_slot_key_idx` ON `methodology_artifact_slot_templates` (`slot_definition_id`,`key`);--> statement-breakpoint
CREATE INDEX `methodology_ast_vid_slot_idx` ON `methodology_artifact_slot_templates` (`methodology_version_id`,`slot_definition_id`);--> statement-breakpoint
...
CREATE TABLE `methodology_transition_workflow_bindings` (
	...
	`updated_at` integer DEFAULT (cast(unixepoch('subsec') * 1000 as integer)) NOT NULL,
	FOREIGN KEY (`methodology_version_id`) REFERENCES `methodology_versions`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`transition_id`) REFERENCES `work_unit_lifecycle_transitions`(`id`) ON UPDATE no action ON DELETE cascade,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `transition_condition_sets_transition_phase_idx` ON `transition_condition_sets` (`transition_id`,`phase`);--> statement-breakpoint
CREATE INDEX `methodology_tcs_vid_transition_idx` ON `transition_condition_sets` (`methodology_version_id`,`transition_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `methodology_fs_vid_wut_key_idx` ON `work_unit_fact_definitions` (`methodology_version_id`,`work_unit_type_id`,`key`);--> statement-breakpoint
CREATE INDEX `methodology_fs_vid_wut_idx` ON `work_unit_fact_definitions` (`methodology_version_id`,`work_unit_type_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `methodology_ls_vid_wut_key_idx` ON `work_unit_lifecycle_states` (`methodology_version_id`,`work_unit_type_id`,`key`);--> statement-breakpoint
CREATE INDEX `methodology_ls_vid_wut_idx` ON `work_unit_lifecycle_states` (`methodology_version_id`,`work_unit_type_id`);--> statement-breakpoint
CREATE TABLE `work_unit_lifecycle_transitions` (
	...
	FOREIGN KEY (`methodology_version_id`) REFERENCES `methodology_versions`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`work_unit_type_id`) REFERENCES `methodology_work_unit_types`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`from_state_id`) REFERENCES `work_unit_lifecycle_states`(`id`) ON UPDATE no action ON DELETE set null,
	FOREIGN KEY (`to_state_id`) REFERENCES `work_unit_lifecycle_states`(`id`) ON UPDATE no action ON DELETE set null
);
--> statement-breakpoint
CREATE UNIQUE INDEX `methodology_lt_vid_wut_key_idx` ON `work_unit_lifecycle_transitions` (`methodology_version_id`,`work_unit_type_id`,`transition_key`);--> statement-breakpoint
CREATE INDEX `methodology_lt_vid_wut_idx` ON `work_unit_lifecycle_transitions` (`methodology_version_id`,`work_unit_type_id`);--> statement-breakpoint
CREATE INDEX `methodology_lt_from_state_idx` ON `work_unit_lifecycle_transitions` (`from_state_id`);--> statement-breakpoint
CREATE INDEX `methodology_lt_to_state_idx` ON `work_unit_lifecycle_transitions` (`to_state_id`);--> statement-breakpoint
